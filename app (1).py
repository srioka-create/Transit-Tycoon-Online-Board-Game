    ...
    **Parameter Tender Kota X:**
    ...
    if submit_l3:
        ...
        if ans_ct == 144 and ans_h3 == 5 and ans_ja == 29:
            ...
            st.error("❌ Proposal ditolak! Periksa kembali nilai CT (Waktu perjalanan+waktu henti+deviasi waktu), Headway (60*LF*Kapasitas/Penumpang sesi sibuk), atau Pembulatan Armada (CT/fa*H).")
